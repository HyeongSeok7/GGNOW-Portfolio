...
> **경기도 행사 · 축제 정보를 한눈에 조회할 수 있는 웹 서비스**  
...
단순 조회 서비스에 그치지 않고, 사용자가 직접 행사를 저장하고 후기를 남기며 마이페이지에서 활동 내역을 확인할 수 있도록 구성했습니다.
...
- **Railway**: `https://ggnow-portfolio-production.up.railway.app/main`
...
### 3. 행사 상세 조회
- 선택한 행사에 대한 상세 정보를 확인할 수 있습니다.
- 상세 페이지에서 리뷰 조회, 리뷰 작성, 즐겨찾기 기능을 함께 사용할 수 있습니다.
...
#### 배운 점
- 외부 API 데이터는 항상 신뢰하기보다, 서비스 목적에 맞게 정제하는 로직이 필요하다는 점을 배웠습니다.
